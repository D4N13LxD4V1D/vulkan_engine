...
auto Pipeline::readFile(const char *filename) -> std::vector<char> {
...
auto Pipeline::createGraphicsPipeline(const char *vertexShaderPath,
                                      const char *fragmentShaderPath,
                                      const PipelineConfigInfo &configInfo)
    -> void {
...
auto Pipeline::createShaderModule(const std::vector<char> &code,
