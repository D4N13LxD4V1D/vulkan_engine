#include <vulkan_engine/swapchain.hpp>
...
auto Swapchain::submitCommandBuffers(const VkCommandBuffer *buffers,
...
auto Swapchain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities)
    -> VkExtent2D {
